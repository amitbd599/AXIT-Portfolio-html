(function ($) {
  ...
  function mainMenu() {
    $(".axit__nav").append(
      '<span class="axit__munu-toggle"><span></span></span>'
    );
    $(".menu-item-has-children").append(
      '<span class="axit__munu-dropdown-toggle"></span>'
    );
    $(".axit__munu-toggle").on("click", function () {
      $(this)
        .toggleClass("axit__toggle-active")
        .siblings(".axit__nav-list")
        .slideToggle();
    });
  ...
  function socialBtnHover() {
    $(".axit__social-btn").hover(function () {
